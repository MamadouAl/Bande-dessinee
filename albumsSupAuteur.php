...
<div id="tableau">
			...
			$pageHTML .= '</tr></table>';
			$pageHTML .= '<form action ="albumsSupAuteur2.php" method="get" >
						<p><input type="hidden" name="bd_num" size ="10" value ="'.$_GET['id'][1].'"/></p>
			      <p><input type="hidden" name="aut_id" size ="10" value ="'.$_GET['id'][0].'"/></p>
			...
			$pageHTML .='<p> <a href="details_album.php?id='.$_GET['id'][1].'"> Abandonner la suppression </a></p> ';
