...
$pageHTML = '<html>
<head>
	<title>Insertion d\'un album à la biblio de cet auteur </title>
...
$pageHTML .='<p> <a href="details_auteur.php?id='.$_GET['aut_id'].'"> Revenir à la bibliographie de l\'auteur </a></p> ';
