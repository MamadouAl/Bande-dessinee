...
$pageHTML = '<html>
<head>
	<title>Suppression d\'un album de cet auteur </title>
...
$pageHTML .='<p> <a href="details_auteur.php?id='.$_GET['aut_id'].'"> Revenir à l\'ensemble des albums de l\'auteur </a></p></div> ';
