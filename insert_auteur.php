...
<div id="body">
			<div id="liens">
					<p>
						...
						<a style=" border-bottom: solid;" href="insert_auteur.php"> Nouvel auteur</a>
					</p>
			</div>
...
<div id="modification">';
		...
		$pageHTML .= '<form action ="insert_auteur2.php" method="get" >
				<table border ="0" align="center">
						<tr><td><p>Nom de l\'auteur :</td><td>
						<input type="text" name= "aut_nom" size ="30" required /> </p></td></tr>

						<tr><td><p>Prénom de l\'auteur :</td><td>
						<input type="text" name= "aut_prenom" size ="30" required/> </p></td></tr>
			  </table>';
