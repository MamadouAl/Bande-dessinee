...
<div id="modification">
				<table border ="0" align="center">' ;
							...
							$supprimer = getAlbumById($_GET['id']) ;

							$pageHTML .= '<tr> <th>Numero</th><th>Titre</th><th>Année</th><th>Page</th><th>Prix</th></tr>';
...
$pageHTML .= '
					<form action ="sup_album2.php" method="get" >
							<p><input type="hidden" name="bd_num" size ="10" value ="'.$supprimer['bd_num'].'"/></p>
						  <p>
							Voulez-vous vraiment supprimer cet album ? <br/>
